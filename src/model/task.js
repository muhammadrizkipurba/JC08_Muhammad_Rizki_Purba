...
const taskSchema = new mongoose.Schema(
  {
    ...
    owner: {
      // Foreign field to _id field in Users collection
...
// taskSchema.statics.findByCredentials = async owner => {
//   const task = await Task.dele({});
...
//   task = task.filter(val => val.owner != owner);
